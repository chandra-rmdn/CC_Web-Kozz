...
<body class="bg-[#F6F5FB]">
    ...
    <main class="px-2 md:px-[61px] pt-[25px] min-h-[calc(100vh-75px)]">
        <section class="bg-white min-h-[calc(100vh-100px)] rounded-t-[20px] shadow-sm px-4 md:px-8 py-6 md:pt-[38px]">
            ...
            <div class="md:px-[62px] md:pt-1">
                <!-- Title -->
                <h1 class="text-lg text-black md:text-xl font-semibold mb-6">Check-in</h1>
                ...
                <div class="border-2 border-gray-200 rounded-[20px] px-6 py-6 max-w-xl w-full">
                    ...
                    <div class="mt-6 text-xs">
                        ...
                        <div class="flex gap-2 items-center mt-2">
                            ...
                            <span id="copy-id-checkin" class="font-medium text-black">qwertyuiop</span>
                            <button type="button" class="js-clipboard tooltip" aria-label="Copy text to clipboard"
                                data-clipboard-target="#copy-id-checkin" data-clipboard-action="copy"
    ...
    <script src="js/helper-clipboard.js"></script>
</body>
